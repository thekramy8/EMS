                        ...
                        <table id="caseLists" class="table table-hover" style="width:100%;font-size:13px;">
                                  <thead>
                                    ...
                                    <th class="text-center">Client Name</th>
                                     <th class="text-center" style="width:100px;">Laywer</th>
                              ...
                              <?php
                                ...
                                <tr>
                                  ...
                                  -->
                                   <!-- <div class="col  d-flex justify-content-center"><button class="btn btn-sm btn-primary" id="" value="<?php echo $row['id'];?>"><img src="./src/img/view (1).png" alt=""> 
                                   </button></div>
                                     -->
